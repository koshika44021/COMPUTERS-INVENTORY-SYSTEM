...
<?php
		$device_query = mysqli_query($conn,"select * from stdevice			
							 ...
							 where dev_status = 'damage' ORDER BY location_details.ld_id DESC")or die(mysqli_error($conn));
...
<?php	
 ...
 <?php	
			   ...
			   OR dev_status = 'damage'    and dev_name = 'mouse'        OR dev_status = 'damage'  and dev_name = 'mse'         OR dev_status = 'damage' and dev_name = 'MOUSE' 
...
<?php	
			   ...
			   OR dev_status = 'damage' and dev_name = 'montr' OR dev_status = 'damage' and dev_name = 'MNTR' OR dev_status = 'damage' and dev_name = '(monitor)'
