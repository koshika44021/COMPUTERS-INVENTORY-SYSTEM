		                                 ...
		                                 <label class="control-label" for="inputEmail">Device Name</label>
			                                <div class="controls">
				                              <select name="dev_id" class="chzn-select"  required/>
				                                 <option></option>
			                                       <?php $device_name =  mysqli_query($conn,"select * from device_name")or die(mysqli_error($conn)); 
...
mysqli_query($conn,"insert into stdevice (dev_id,dev_desc,dev_serial,dev_brand,dev_model,dev_status) values('$dev_id','$dev_desc','$dev_serial','$dev_brand','$dev_model','$dev_status')")or die(mysqli_error($conn));
mysqli_query($conn,"insert into notification (fullname,notification,date_of_notification,link) value('$client_fullname','Add device id $dev_id, Serial Number: $dev_serial',NOW(),'device_stocks.php')")or die(mysqli_error($conn));										
?>
<script>
window.location = "device_stocks.php";
