     ...
     <body id="home">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_item=mysqli_query($conn,"select * from stdevice LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id");
...
<?php
		...
		<td><?php
			...
			<td><?php
			   $device_query1 = mysqli_query($conn,"select * from stdevice ")or die(mysqli_error($conn));
