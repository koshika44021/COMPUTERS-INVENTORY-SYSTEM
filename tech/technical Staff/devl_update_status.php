									...
									?>
									 ...
									 <form class="form-horizontal" method="post">
									   ...
									   <div class="control-group">
											...
											<div class="controls">			
												<select id="qtype" name="dev_id" readonly="readonly" required>
													...
													<?php
													$device_query = mysqli_query($conn,"select * from device_name")or die(mysql_error($conn));
									  ...
									  <div id="hide">
										...
										value('$client_fullname','Update Status $dev_name, Serial Number:&nbsp;&nbsp;$dev_serial' ,NOW(), 'damage.php')")or die(mysqli_error($conn));			
										?>
										<script>
