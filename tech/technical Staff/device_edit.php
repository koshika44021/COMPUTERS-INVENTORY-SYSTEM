		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div id="" class="block">
									...
									?>
										...
										mysqli_query($conn,"update stdevice set dev_id = '$dev_id' ,
																		dev_desc = '$dev_desc',
										...
										mysqli_query($conn,"insert into notification (fullname,notification,date_of_notification,link) value('$client_fullname','Edit device $dev_name, Serial Number: $dev_serial',NOW(),'device_stocks.php')")or die(mysqli_error($conn));	
										?>
										<script>										
