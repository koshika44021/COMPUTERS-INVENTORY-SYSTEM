...
<?php 
mysqli_query($conn,"update stdevice set dev_status='Dump' where id = '$get_id'")or die(mysqli_error($conn));
mysqli_query($conn,"insert into notification (fullname,notification,date_of_notification,link) 
			value('$client_fullname','Dump $dev_name, Serial Number: $dev_serial' ,NOW(), 'dump_device.php')")or die(mysqli_error($conn));					
