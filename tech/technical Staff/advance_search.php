...
<?php
		...
		<tr>
		<td><?php
			   $device_query2 = mysqli_query($conn,"select * from stdevice ")or die(mysql_error($conn));
			...
			<td><?php
			   $device_query1 = mysqli_query($conn,"select * from stdevice ")or die(mysql_error($conn));
