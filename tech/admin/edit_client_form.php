	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($conn,"select * from client where client_id = '$get_id'")or die(mysqli_error($conn));
...
mysqli_query($conn,"update client set username = '$username'  , firstname = '$firstname' , lastname = '$lastname' where client_id = '$get_id' ")or die(mysqli_error($conn));

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Client User $firstname')")or die(mysqli_error($conn));	
?>
<script>
