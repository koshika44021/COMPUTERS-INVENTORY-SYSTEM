	               ...
	               <script type="text/javascript">
		              ...
		              $('#add').tooltip('hide');
                        ...
                        <div class="block">
							...
							<?php
							$query = mysqli_query($conn,"select * from stlocation where stdev_id = '$get_id'")or die(mysqli_error($conn));
...
mysqli_query($conn,"update stlocation set stdev_location_name = '$stdev_location_name' where stdev_id = '$get_id' ")or die(mysqli_error($conn));

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit location $stdev_location_name')")or die(mysqli_error($conn));
?>
