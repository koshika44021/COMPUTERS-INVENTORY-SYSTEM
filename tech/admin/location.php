                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							   <div class="muted pull-left"><i class="icon-reorder icon-building"></i> location List</div>                       
								...
								<?php 
								$my_location = mysqli_query($conn,"select * from stlocation ")or die(mysqli_error($conn));
                                ...
                                <div class="span12">
									<form action="delete_location.php" method="post">
									  ...
									  <thead>
										...
										<tbody>
										<?php
										$location_query = mysqli_query($conn,"select * from stlocation")or die(mysqli_error($conn));
