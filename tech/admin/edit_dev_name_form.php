	...
	$('#add').tooltip('hide');
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php
								$query = mysqli_query($conn,"select * from device_name where dev_id = '$get_id'")or die(mysqli_error($conn));
...
mysqli_query($conn,"update device_name set dev_name = '$dev_name'  where dev_id = '$get_id' ")or die(mysqli_error($conn));

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Edit Device Type $dev_name')")or die(mysqli_error($conn));	
?>
<script>
