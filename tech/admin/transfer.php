									   ...
									   <div class="control-group">
										...
										<div class="control-group">
		                                  <label class="control-label" for="inputEmail">Move TO</label>
				                            ...
				                            <option></option>
			                                 <?php $result =  mysqli_query($conn,"select * from stlocation")or die(mysqli_error($conn)); 
										...
										mysqli_query($conn,"update location_details set
										            date_deployment = '$ora',
													stdev_id = '$stdev_id'													
													where id = '$get_id' ")or die(mysqli_error($conn));
													
										mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','transfer Device  $dev_name to location id $stdev_id')")or die(mysqli_error($conn));			
										?>
										<script>
