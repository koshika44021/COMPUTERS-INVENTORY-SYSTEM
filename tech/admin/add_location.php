...
$query = mysqli_query($conn,"select * from stlocation where stdev_location_name  =  '$stdev_location_name' ")or die(mysqli_error($conn));
...
mysqli_query($conn,"insert into stlocation (stdev_location_name,thumbnails) values('$stdev_location_name','images/thumbnails.jpg')")or die(mysqli_error($conn));

mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Add location $stdev_location_name')")or die(mysqli_error($conn));
?>
<script>
