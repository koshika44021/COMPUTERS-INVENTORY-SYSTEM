                      ...
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <div id="block_bg" class="block">
                           ...
                           <?php 
								...
								where dev_status = 'New' ORDER BY stdevice.id DESC")or die(mysqli_error($conn));
								...
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_status = 'damage' OR dev_status = 'Damage' ORDER BY stdevice.id DESC")or die(mysqli_error($conn));
								...
								<?php 
								$device_location = mysqli_query($conn,"select * from location_details")or die(mysqli_error($conn));
								$device_location = mysqli_num_rows($device_location);
								?>
								...
								<?php 
								$keyboard = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = '(kbrd)' ")or die(mysqli_error($conn));
								$keyboard = mysqli_num_rows($keyboard);
								?>
								...
								<?php 
								$Mouse = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = 'Mouse-PS2' OR dev_name = 'Mouse-USB' OR dev_name = 'Mouse PS2' OR dev_name = 'Mouse USB' 
			                    ORDER BY stdevice.id DESC")or die(mysqli_error($conn));
								$Mouse = mysqli_num_rows($Mouse);
								?>
								...
								<?php 
								$Monitor = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								where dev_name = 'Monitor' OR dev_name = 'monitor'
			                     ...
			                     OR dev_name = '(monitor)' OR dev_name = '(montor)' ")or die(mysqli_error($conn));
								$Monitor = mysqli_num_rows($Monitor);
								?>
								...
								<?php 
								$CPU = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = '(CPU)' OR dev_name = '(Central Processing unit (CPU))' ")or die(mysqli_error($conn));
								$CPU = mysqli_num_rows($CPU);
								?>
								...
								<?php 
								$power_supply = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								OR dev_name = '(power-supply)' OR dev_name = 'POWER SUPPLY' ")or die(mysqli_error($conn));
								$power_supply = mysqli_num_rows($power_supply);
								?>
								...
								<?php 
								$vga = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			                    ...
			                    OR dev_name = 'vedeo graphic' OR dev_name = 'video graphic accelerator'")or die(mysqli_error($conn));
								$vga = mysqli_num_rows($vga);
								?>
								...
								<?php 
								$power_cords = mysqli_query($conn,"select * from stdevice 
								LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
								...
								OR dev_name = 'powe cor'  OR dev_name = 'power-cord'")or die(mysqli_error($conn));
								$power_cords = mysqli_num_rows($power_cords);
								?>
