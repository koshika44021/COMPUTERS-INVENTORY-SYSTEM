...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
			  ...
			  <?php
				$class_query = mysqli_query($conn,"select * from stlocation")or die(mysqli_error($conn));
			  ...
			  <?php
				$serial_query = mysqli_query($conn,"select * from stdevice")or die(mysqli_error($conn));
