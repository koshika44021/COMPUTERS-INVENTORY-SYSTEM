...
mysqli_query($conn,"insert into activity_log (date,username,action) values(NOW(),'$admin_username','Dump Device $dev_name Inventory Code:$dev_serial')")or die(mysqli_error($conn));						
