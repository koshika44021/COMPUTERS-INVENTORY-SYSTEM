...
<tr>
		<td><?php
			   $device_query2 = mysqli_query($conn,"select * from stdevice ")or die(mysqli_error($conn));
			...
			<td><?php
			   $my_device1 = mysqli_query($conn,"select * from stdevice ")or die(mysqli_error($conn));
