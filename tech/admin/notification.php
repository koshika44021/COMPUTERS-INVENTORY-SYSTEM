...
<form action="read.php" method="post">
					...
					<?php } ?>
					   ...
					   <?php $query = mysqli_query($conn,"select * from notification order by notification.date_of_notification DESC")or die(mysqli_error($conn));
					                    ...
					                    $query_yes_read = mysqli_query($conn,"select * from notification_read where notification_id = '$id' and admin_id = '$session_id'")or die(mysqli_error($conn));
